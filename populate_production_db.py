#!/usr/bin/env python
"""
Populate production Railway database with sample data
This script will add categories and products to your production database
"""
...
def create_products():
    ...
    products_data = [
        ...
        },
        {
            ...
            'slug': 'ennc-athletic-shorts-grey',
            'price': Decimal('30.00'),
